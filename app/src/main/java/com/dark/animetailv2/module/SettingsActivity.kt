...
class SettingsActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pillScaleInput = EditText(this)
        ...
        mainLayout.addView(createCard("SPEED CONTROL",
            ...
            createLabel("Drag Sensitivity (Pixels):"), dragSensitivityInput, dragSensitivityHelper,
            createLabel("Pill Scale (%):"), pillScaleInput, pillScaleHelper,
        ...
        pillScaleInput.setText(prefs.getString("pill_scale", "100"))
        ...
        val saveBtn = Button(this).apply {
            ...
            setOnClickListener {
                ...
                editor.putString("pill_scale", validateAndCoerce(pillScaleInput, 50.0, 300.0, 100.0, pillScaleHelper).toInt().toString())
